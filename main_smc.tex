...
Algorithm~1 summarizes this inference flow: normalize the input, route the request, run the specialist agents in parallel, retrieve instructional materials only when $G(x)=1$, assemble one generator prompt, and apply one critic pass.
